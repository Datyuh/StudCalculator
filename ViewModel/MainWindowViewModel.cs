...
namespace StudCalculator.ViewModel
{
    internal class MainWindowViewModel : BaseViewModel
    {
        ...
        public ObservableCollection<string> AllGost
        {
            get => _allGost;
            set => Set(ref _allGost, value);
        }
        ...
        public ObservableCollection<string> ExecGost
        {
            get => _execGost;
            set => Set(ref _execGost, value);
        }

        //Выборка из базы PN
        private ObservableCollection<string> _executionPn = new ObservableCollection<string>();

        public ObservableCollection<string> ExecutionPn
        {
            get => _executionPn;
            set => Set(ref _executionPn, value);
        }

        //Выборка из базы DN
        private ObservableCollection<string> _executionDn = new ObservableCollection<string>();

        public ObservableCollection<string> ExecutionDn
        {
            get => _executionDn;
            set => Set(ref _executionDn, value);
        }
        ...
        public ObservableCollection<string> ExecutionType
        {
            get => _executionType;
            set => Set(ref _executionType, value);
        }
        ...
        public ObservableCollection<string> AllCaps
        {
            get => _allCaps;
            set => Set(ref _allCaps, value);
        }
        ...
        public ObservableCollection<string> ExecutePlugsCollection
        {
            get => _executePlugsCollection;
            set => Set(ref _executePlugsCollection, value);
        }
        ...
        public ObservableCollection<string> ExecuteRotaryPlugsCollection
        {
            get => _executeRotaryPlugsCollection;
        ...
        {
            get => _ostNutsCollection;
            set => Set(ref _ostNutsCollection, value);
        }

        //Выборка из базы резьб
        private ObservableCollection<string> _extractNutsCollection;

        public ObservableCollection<string> ExtractNutsCollection
        {
            get => _extractNutsCollection;
            set => Set(ref _extractNutsCollection, value);
        }
        ...
        {
            get => _extractMaterialStudCollection;
            set => Set(ref _extractMaterialStudCollection, value);
        }

        //Выборка из базы исполнений шпилек
        private ObservableCollection<string> _extractExecutionStudCollection;

        public ObservableCollection<string> ExtractExecutionStud
        {
            get => _extractExecutionStudCollection;
            set => Set(ref _extractExecutionStudCollection, value);
        }
        ...
        public bool NonStandartSameFlangeChecked
        {
            get => _nonStandartSameFlangeChecked;
            set => Set(ref _nonStandartSameFlangeChecked, value);
        }

        //Чекбокс для разных нестандартных фланцев
        private bool _nonStandartDifferentFlangeChecked;

        public bool NonStandartDifferentFlangeChecked
        {
            get => _nonStandartDifferentFlangeChecked;
            set => Set(ref _nonStandartDifferentFlangeChecked, value);
        }

        //Чекбокс для стандартных заглушек
        private bool _standartPlugsChecked;

        public bool StandartPlugsChecked
        {
            get => _standartPlugsChecked;
            set => Set(ref _standartPlugsChecked, value);
        }

        //Чекбокс для нестандартных заглушек
        private bool _nonStandartPlugsChecked;

        public bool NonStandartPlugsChecked
        {
            get => _nonStandartPlugsChecked;
            set => Set(ref _nonStandartPlugsChecked, value);
        }

        //Чекбокс для стандартных заглушек поворотных
        private bool _standartRotaryPlugsChecked;

        public bool StandartRotaryPlugsChecked
        {
            get => _standartRotaryPlugsChecked;
            set => Set(ref _standartRotaryPlugsChecked, value);
        }

        //Чекбокс для нестандартных заглушек поворотных
        private bool _nonstandartRotaryPlugsChecked;

        public bool NonStandartRotaryPlugsChecked
        {
            get => _nonstandartRotaryPlugsChecked;
            set => Set(ref _nonstandartRotaryPlugsChecked, value);
        }

        //Чекбокс для нестандартных толщина шайб
        private bool _standartThicknessWasherCheckboxChecked;

        public bool StandartThicknessWasherCheckboxChecked
        {
            get => _standartThicknessWasherCheckboxChecked;
            set => Set(ref _standartThicknessWasherCheckboxChecked, value);
        }

        //Чекбокс для стандартных шайб
        private bool _nonStandartThicknessWasherCheckboxChecked;

        public bool NonStandartThicknessWasherCheckboxChecked
        {
            get => _nonStandartThicknessWasherCheckboxChecked;
            set => Set(ref _nonStandartThicknessWasherCheckboxChecked, value);
        }

        //Чекбокс для овальных прокладок
        private bool _standartOvalGasketsCheckboxChecked;

        public bool StandartOvalGasketsCheckboxChecked
        {
            get => _standartOvalGasketsCheckboxChecked;
            set => Set(ref _standartOvalGasketsCheckboxChecked, value);
        }

        //Чекбокс для восьмигранных прокладок
        private bool _standartOctahedralGasketsCheckboxChecked;

        public bool StandartOctahedralGasketsCheckboxChecked
        {
            get => _standartOctahedralGasketsCheckboxChecked;
            set => Set(ref _standartOctahedralGasketsCheckboxChecked, value);
        }
        ...
        public bool NonStandartFlTextIsEnabled
        {
            get => _nonStandartFlTextIsEnabled;
            set => Set(ref _nonStandartFlTextIsEnabled, value);
        }

        //Текстбокс для разных нестандартных фланцев
        private bool _nonStandartDifferentFlangeTexboxIsEnabled;

        public bool NonStandartDifferentFlangeTexboxIsEnabled
        {
            get => _nonStandartDifferentFlangeTexboxIsEnabled;
            set => Set(ref _nonStandartDifferentFlangeTexboxIsEnabled, value);
        }

        //Текстбокс для нестандартных заглушек
        private bool _nonStandartPlugsTextboxEsInEnabled;

        public bool NonStandartPlugsTextboxIsEnabled
        {
            get => _nonStandartPlugsTextboxEsInEnabled;
        ...
        public bool NumberOfNutsTextboxIsEnable
        {
            get => _numberOfNutsTextboxIsEnabled;
            set => Set(ref _numberOfNutsTextboxIsEnabled, value);
        }

        //Текстбокс для заглушек поворотных
        private bool _nonstandartRotaryPlugsTextboxIsEnabled;

        public bool NonStandartRotaryPlugsTextboxIsEnabled
        {
            get => _nonstandartRotaryPlugsTextboxIsEnabled;
        ...
        public bool NonThicknessWasherTextboxIsEnabled
        {
            get => _nonThicknessWasherTextboxIsEnabled;
            set => Set(ref _nonThicknessWasherTextboxIsEnabled, value);
        }

        //Текстбокс для прокладок
        private bool _nonStandartGasketsTextboxIsEnabled = true;

        public bool NonStandartGasketsTextboxIsEnabled
        {
            get => _nonStandartGasketsTextboxIsEnabled;
            set => Set(ref _nonStandartGasketsTextboxIsEnabled, value);
        }
        ...
        public bool StandartPlugsComboboxIsEnabled
        {
            get => _standartPlugsComboboxIsEnabled;
            set => Set(ref _standartPlugsComboboxIsEnabled, value);
        }

        //Комбобокс стандартные заглушки и крышки выбор исполнения
        private bool _standartPlugsExecutionComboboxIsEnabled;

        public bool StandartPlugsExecutionComboboxIsEnabled
        {
            get => _standartPlugsExecutionComboboxIsEnabled;
            set => Set(ref _standartPlugsExecutionComboboxIsEnabled, value);
        }

        //Комбобокс выбор резьбы на гайки для нестандартных фланцев
        private bool _choeseNutsThreadComboboxIsEnabled;

        public bool ChoeseNutsThreadComboboxIsEnabled
        {
            get => _choeseNutsThreadComboboxIsEnabled;
            set => Set(ref _choeseNutsThreadComboboxIsEnabled, value);
        }

        //Комбобокс стандартные заглушки поворотные выбор исполнения
        private bool _standartRotaryPlugsComboboxIsEnabled;

        public bool StandartRotaryPlugsComboboxIsEnabled
        {
            get => _standartRotaryPlugsComboboxIsEnabled;
        ...
        public bool TypeFlangeGostIsEnabled
        {
            get => _typeFlangeGostIsEnabled;
            set => Set(ref _typeFlangeGostIsEnabled, value);
        }
        ...
        public bool NonStandartStandartSameFlangeCheckedIsEnabled
        {
            get => _nonStandartStandartSameFlangeCheckedIsEnabled;
            set => Set(ref _nonStandartStandartSameFlangeCheckedIsEnabled, value);
        }

        //Чекбокс для разных нестандартных фланцев
        private bool _nonStandartDifferentFlangeCheckedIsEnabled = true;

        public bool NonStandartDifferentFlangeCheckedIsEnabled
        {
            get => _nonStandartDifferentFlangeCheckedIsEnabled;
            set => Set(ref _nonStandartDifferentFlangeCheckedIsEnabled, value);
        }

        //Чекбокс для стандартных заглушек
        private bool _standartPlugsCheckboxIsEnabled = true;

        public bool StandartPlugsCheckboxIsEnabled
        {
            get => _standartPlugsCheckboxIsEnabled;
            set => Set(ref _standartPlugsCheckboxIsEnabled, value);
        }

        //Чекбокс для нестандартных заглушек
        private bool _nonStandartPlugsCheckboxIsEnabled = true;

        public bool NonStandartPlugsCheckboxIsEnabled
        {
            get => _nonStandartPlugsCheckboxIsEnabled;
            set => Set(ref _nonStandartPlugsCheckboxIsEnabled, value);
        }

        //Чекбокс для стандартных заглушек поворотных
        private bool _standartRotaryPlugsCheckboxIsEnabled = true;

        public bool StandartRotaryPlugsCheckboxIsEnabled
        {
            get => _standartRotaryPlugsCheckboxIsEnabled;
        ...
        public bool NonStandartRotaryPlugsCheckboxIsEnabled
        {
            get => _nonstandartRotaryPlugsCheckboxIsEnabled;
        ...
        public bool StandartThicknessWasherCheckboxIsEnabled
        {
            get => _standartThicknessWasherCheckboxIsEnabled;
            set => Set(ref _standartThicknessWasherCheckboxIsEnabled, value);
        }

        //Чекбокс для стандартных шайб
        private bool _nonStandartThicknessWasherCheckboxIsEnabled = true;

        public bool NonStandartThicknessWasherCheckboxIsEnabled
        {
            get => _nonStandartThicknessWasherCheckboxIsEnabled;
            set => Set(ref _nonStandartThicknessWasherCheckboxIsEnabled, value);
        }

        //Чекбокс для овальных прокладок
        private bool _standartOvalGasketsCheckboxIsEnabled = true;

        public bool StandartOvalGasketsCheckboxIsEnabled
        {
            get => _standartOvalGasketsCheckboxIsEnabled;
            set => Set(ref _standartOvalGasketsCheckboxIsEnabled, value);
        }

        //Чекбокс для восьмигранных прокладок
        private bool _standartOctahedralGasketsCheckboxIsEnabled = true;

        public bool StandartOctahedralGasketsCheckboxIsEnabled
        {
            get => _standartOctahedralGasketsCheckboxIsEnabled;
            set => Set(ref _standartOctahedralGasketsCheckboxIsEnabled, value);
        }
        ...
        public string NonStandartFlTextRead
        {
            get => _nonStandartFlTextRead;
            set => Set(ref _nonStandartFlTextRead, value);
        }

        //Текстбокс для не одинаковых нестандартных фланцев 1 фланец
        private string _nonStandartFirstFlangeTextRead;

        public string NonStandartFirstFlangeTextRead
        {
            get => _nonStandartFirstFlangeTextRead;
            set => Set(ref _nonStandartFirstFlangeTextRead, value);
        }

        //Текстбокс для не одинаковых нестандартных фланцев 2 фланец
        private string _nonStandartSecondFlangeTextRead;

        public string NonStandartSecondFlangeTextRead
        {
            get => _nonStandartSecondFlangeTextRead;
            set => Set(ref _nonStandartSecondFlangeTextRead, value);
        }

        //Текстбокс для нестандартных заглушек и крышек
        private string _nonStandartPlugsTextRead;

        public string NonStandartPlugsTextRead
        {
            get => _nonStandartPlugsTextRead;
            set => Set(ref _nonStandartPlugsTextRead, value);
        }

        //Текстбокс для нестандартных заглушек поворотных
        private string _nonStandartRotaryPlugsTextRead;

        public string NonStandartRotaryPlugsTextRead
        {
            get => _nonStandartRotaryPlugsTextRead;
            set => Set(ref _nonStandartRotaryPlugsTextRead, value);
        }

        //Текстбокс для кол-ва фланцев
        private string _sumFlangeTextRead;

        public string SumFlangeTextRead
        {
            get => _sumFlangeTextRead;
            set => Set(ref _sumFlangeTextRead, value);
        }

        //Текстбокс для толщины шайб
        private string _thicknessWasherTextRead;

        public string ThicknessWasherTextRead
        {
            get => _thicknessWasherTextRead;
            set => Set(ref _thicknessWasherTextRead, value);
        }

        //Текстбокс для для толщины прокладок
        private string _thicknessGasketTextRead;

        public string ThicknessGasketTextRead
        {
            get => _thicknessGasketTextRead;
            set => Set(ref _thicknessGasketTextRead, value);
        }

        //Текстбокс для кол-ва шпилек
        private string _sumStudTextRead;

        public string SumStudTextRead
        {
            get => _sumStudTextRead;
            set => Set(ref _sumStudTextRead, value);
        }
        ...
        public string TypeSelectedFromComboBox
        {
            get => _typeSelectedFromComboBox;
            set => Set(ref _typeSelectedFromComboBox, value);
        }

        //Получение значений для Давления
        private string _pnSelectedFromComboBox;

        public string PnSelectedFromComboBox
        {
            get => _pnSelectedFromComboBox;
            set => Set(ref _pnSelectedFromComboBox, value);
        }
        ...
        public string ExecutionFromComboBox
        {
            ...
            set => Set(ref _executionFromComboBox, value);
        }

        //Получение значений для Диаметра внутреннего
        private string _dnSelectedFromComboBox;

        public string DnSelectedFromComboBox
        {
            get => _dnSelectedFromComboBox;
            set => Set(ref _dnSelectedFromComboBox, value);
        }

        //Получение значений для заглушек поворотных
        private string _standartRotaryPlugFromComboBox;

        public string StandartRotaryPlugFromComboBox
        {
            get => _standartRotaryPlugFromComboBox;
            set => Set(ref _standartRotaryPlugFromComboBox, value);
        }

        //Получение значений для заглушек и крышек
        private string _standartPlugsFromComboBox;

        public string StandartPlugsFromComboBox
        {
            get => _standartPlugsFromComboBox;
            set
            {
        ...
        public string StandartPlugsExecutionFromComboBox
        {
            get => _standartPlugsExecutionFromComboBox;
            set => Set(ref _standartPlugsExecutionFromComboBox, value);
        }

        //Получение значений исполнения шпилек
        private string _executionStudFromCombobox;

        public string ExecutionStudFromCombobox
        {
            get => _executionStudFromCombobox;
            set => Set(ref _executionStudFromCombobox, value);
        }

        //Получение значений для материала шпилек
        private string _materialStudFromCombobox;

        public string MaterialStudFromCombobox
        {
            get => _materialStudFromCombobox;
            set => Set(ref _materialStudFromCombobox, value);
        }

        //Получение значений ОСТа на гайки
        private string _ostNutsFromComboBox;

        public string OstNutsFromComboBox
        {
            get => _ostNutsFromComboBox;
            set => Set(ref _ostNutsFromComboBox, value);
        }

        //Получение значений резьбы для шайб
        private string _threadNutsFromComboBox;

        public string ThreadNutsFromComboBox
        {
            get => _threadNutsFromComboBox;
            set => Set(ref _threadNutsFromComboBox, value);
        }
        ...
        public string ResultTextEnter
        {
            get => _resultTextEnter;
            set => Set(ref _resultTextEnter, value);
        }
        ...
        private void OnOutputValuesFromControlCommandExecuted(object p)
        {
            var receiptAndDistributionOfDatas = new Dictionary<string, object>
            {
                ...
                {"PnSelectedFromComboBox", PnSelectedFromComboBox}, {"ExecutionFromComboBox", ExecutionFromComboBox},
                ...
                {"MaterialStudFromCombobox", MaterialStudFromCombobox}, {"OstNutsFromComboBox", OstNutsFromComboBox},
                ...
                {"SumFlangeTextRead", SumFlangeTextRead}, {"ThicknessWasherTextRead", ThicknessWasherTextRead},
            ...
            if (ResultTextEnter == "Вывод результатов...")
            {
                ...
                ResultTextEnter =
                    new ReceiptAndDistributionData(receiptAndDistributionOfDatas, receiptAndDistributionOfDataCheckBox)
                        .ResultOutBaseAllGosts();
            }
            else
            {
                ColorTextBoxResult = Brushes.Black;
                ResultTextEnter += "\r\n" + new ReceiptAndDistributionData(receiptAndDistributionOfDatas, receiptAndDistributionOfDataCheckBox).ResultOutBaseAllGosts();
            }
